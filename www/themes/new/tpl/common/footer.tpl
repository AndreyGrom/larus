                    ...
                    <div class="row row-flex mobile-margin-bottom">
                        ...
                        <div class="col-sm-2 col-xs-4 text-center">
                            <a href="/partners/kompaniya-nota">
                                <img class="img-responsive" src="{$theme_dir}img/p1.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-sm-3 col-xs-4 text-center">
                            <a href="/partners/kompaniya-mmc">
                                <img class="img-responsive" src="{$theme_dir}img/p2.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-sm-3 col-xs-4 text-center">
                            <a href="/partners/smartaudio-recording-lab">
                                <img class="img-responsive" src="{$theme_dir}img/p3.jpg" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row row-flex">
                        ...
                        <div class="col-sm-3 text-center">
                            <a href="/partners/triumf-audio-g-sankt-peterburg">
                                <img class="img-responsive" src="{$theme_dir}img/p4.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-sm-3 text-center">
                            <a href="/partners/interergalereya-viessman-belorusssiya-g-minsk">
                                <img class="img-responsive" src="{$theme_dir}img/p5.jpg" alt="">
                            </a>
                        </div>
                    </div>
                </div>
