            ...
            <h3 class="panel-title text-uppercase">
                ...
                {if !$new}
                    <span class="pull-right text-lowercase">
                        ...
                        <a href="?c=blog&act=del&cid={$category_id}" class="btn btn-danger btn-xs confirm" data-toggle="tooltip" title="" data-original-title="Удалить категорию"><span class="glyphicon glyphicon-remove"></span></a>
                    </span>
                {/if}
            </h3>
        </div>
