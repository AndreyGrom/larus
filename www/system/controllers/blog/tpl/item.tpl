            ...
            <h3 class="panel-title text-uppercase">
                ...
                {if !$new}
                    <span class="pull-right text-lowercase">
                            ...
                            <a href="?c=blog&act=del-item&id={$item_id}&cid={$item_parents[0]}" class="btn btn-danger btn-xs confirm" data-toggle="tooltip" title="" data-original-title="Удалить материал"><span class="glyphicon glyphicon-remove"></span></a>
                    </span>
                {/if}
            ...
            {if !$new}
                <div class="alert alert-info">
                    <div class="row">
                        ...
                        <span class="col-sm-9"><a target="_blank" href="{$site_url}blog/{$item_alias}">{$site_url}blog/{$item_alias}</a></span>
                    </div>
                    <div class="row">
                        <span class="col-sm-3 text-right">Короткая ссылка:</span>
                        <span class="col-sm-9"><a target="_blank" href="{$site_url}blog/{$item_id}">{$site_url}blog/{$item_id}</a></span>
                    </div>
                </div>
            {/if}
            <div class="tabs">
