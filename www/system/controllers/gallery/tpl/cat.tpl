            ...
            <h3 class="panel-title text-uppercase">
                ...
                {if !$new}
                    <span class="pull-right text-lowercase">
                        <a href="?c=gallery&act=new_c" class="btn btn-info btn-xs" data-toggle="tooltip" title="" data-original-title="Создать новую категорию"><span class="glyphicon glyphicon-copy"></span></a>
                        <a href="?c=gallery&act=del&cid={$category_id}" class="btn btn-danger btn-xs confirm" data-toggle="tooltip" title="" data-original-title="Удалить категорию"><span class="glyphicon glyphicon-remove"></span></a>
                    </span>
                {/if}
            </h3>
        </div>
