            ...
            <h3 class="panel-title text-uppercase">
                ...
                {if !$new}
                    <span class="pull-right text-lowercase">
                            <a href="?c=gallery&act=new" class="btn btn-info btn-xs" data-toggle="tooltip" title="" data-original-title="Создать новвый материал"><span class="glyphicon glyphicon-copy"></span></a>
                            <a href="?c=gallery&act=del-item&id={$item_id}&cid={$item_parents[0]}" class="btn btn-danger btn-xs confirm" data-toggle="tooltip" title="" data-original-title="Удалить материал"><span class="glyphicon glyphicon-remove"></span></a>
                    </span>
                {/if}
            ...
            {if !$new}
                <div class="alert alert-info">
                    <div class="row">
                        ...
                        <span class="col-sm-9"><a target="_blank" href="{$site_url}gallery/{$item_alias}">{$site_url}gallery/{$item_alias}</a></span>
                    </div>
                    <div class="row">
                        <span class="col-sm-3 text-right">Короткая ссылка:</span>
                        <span class="col-sm-9"><a target="_blank" href="{$site_url}gallery/{$item_id}">{$site_url}gallery/{$item_id}</a></span>
                    </div>
                </div>
            {/if}
            <div class="tabs">
