<div class="form-horizontal" role="form">
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input required value="{$item.SORT}" name="sort" id="sort" type="text" class="form-control" placeholder="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="alias" class="col-sm-3 control-label">Ссылка в магазине:</label>
        <div class="col-sm-9">
            <input value="{$item.LINK}" name="link" id="link" type="text" class="form-control" placeholder="" />
            <p class="help-block">Можно относительный URL</p>
        </div>
    </div>
    <div class="form-group">
