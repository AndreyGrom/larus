    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title text-uppercase">
                ...
                {if $new}Создание нового канала{else}Редактирование канала{/if}
                {if !$new}
                    <span class="pull-right text-lowercase">
                        <a href="?c=video&act=new_c" class="btn btn-info btn-xs" data-toggle="tooltip" title="" data-original-title="Создать новый канал"><span class="glyphicon glyphicon-copy"></span></a>
                        <a href="?c=video&act=del&cid={$category_id}" class="btn btn-danger btn-xs confirm" data-toggle="tooltip" title="" data-original-title="Удалить канал"><span class="glyphicon glyphicon-remove"></span></a>
                    </span>
                {/if}
            </h3>
        </div>
        <div class="panel-body">
            ...
            <div class="form-horizontal" role="form">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input required value="{$category_title}" name="c_title" id="c_title" type="text" class="form-control" placeholder="Введите название канала">
                    </div>
                </div>
                <div class="form-group">
