...
CREATE TABLE IF NOT EXISTS `agcms_country` (
  `COUNTRY_ID` int(11) NOT NULL AUTO_INCREMENT,
  `NAME` varchar(128) COLLATE utf8_bin NOT NULL,
  `ICO_CODE_2` varchar(2) COLLATE utf8_bin NOT NULL DEFAULT '',
  `ICO_CODE_3` varchar(3) COLLATE utf8_bin NOT NULL DEFAULT '',
...
INSERT INTO `agcms_country` (`COUNTRY_ID`, `NAME`, `ICO_CODE_2`, `ICO_CODE_3`, `ADDRESS_FORMAT`, `POSTCODE_REQUIRED`, `STATUS`) VALUES
