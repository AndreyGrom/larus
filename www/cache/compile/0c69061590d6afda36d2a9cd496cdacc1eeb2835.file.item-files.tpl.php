<?php /* Smarty version Smarty-3.1.21-dev, created on 2021-10-18 13:48:13
         compiled from "D:\data\domains\provoda\www\system\controllers\blog\tpl\item-files.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1588533501616d50ed9ebf21-57627836%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0c69061590d6afda36d2a9cd496cdacc1eeb2835' => 
    array (
      0 => 'D:\\data\\domains\\provoda\\www\\system\\controllers\\blog\\tpl\\item-files.tpl',
      1 => 1626993005,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1588533501616d50ed9ebf21-57627836',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_616d50ed9fb924_24369608',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_616d50ed9fb924_24369608')) {function content_616d50ed9fb924_24369608($_smarty_tpl) {?><div class="form-horizontal" role="form">
...
>
                $(function(){
                    ...
                    var au = new AjaxUpload(btnUpload, {
                        action: '/system/controllers/blog/upload.php?id=<?php echo $_smarty_tpl->tpl_vars['item_id']->value;?>
',
                        name: 'file',
                        autoSubmit: false,
                    ...
                    jQuery('body').on('click', 'a.del-file', function(e) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "/system/controllers/blog/upload.php",
