<?php /* Smarty version Smarty-3.1.21-dev, created on 2021-12-04 14:05:22
         compiled from "D:\data\domains\provoda\www\system\controllers\pages\tpl\new.tpl" */ ?>
<?php /*%%SmartyHeaderCode:54723754661ab4b72e759f8-57989523%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '54723754661ab4b72e759f8-57989523',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61ab4b72f31223_68078044',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61ab4b72f31223_68078044')) {function content_61ab4b72f31223_68078044($_smarty_tpl) {?><form id="page-form" action="" method="post" enctype="multipart/form-data">
...
" name="title" id="title" type="text" class="form-control" placeholder="Введите название страницы">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input value="<?php echo $_smarty_tpl->tpl_vars['page']->value['TITLE2'];?>
" name="title2" id="title2 " type="text" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="hidden" name="old_image" value="<?php echo $_smarty_tpl->tpl_vars['page']->value['IMAGE'];?>
"/>
                        <p class="help-block">.jpg, .jpeg, .png, .gif</p>
                    </div>
                    <div class="col-sm-3">
                        <?php if ($_smarty_tpl->tpl_vars['page']->value['IMAGE']) {?>
                            <a target="_blank" class="fancybox" href="/upload/images/pages/<?php echo $_smarty_tpl->tpl_vars['page']->value['IMAGE'];?>
">
                                <img class="img-responsive" src="/upload/images/pages/<?php echo $_smarty_tpl->tpl_vars['page']->value['IMAGE'];?>
" alt=""/>
                            </a>
