<?php /* Smarty version Smarty-3.1.21-dev, created on 2021-12-13 14:46:52
         compiled from "D:\data\domains\provoda\www\system\controllers\shop\tpl\cat.tpl" */ ?>
<?php /*%%SmartyHeaderCode:76331099861af434b28c5d1-76086410%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2b4f834dde77a555d1b0cf6837096592984d4f7a' => 
    array (
      0 => 'D:\\data\\domains\\provoda\\www\\system\\controllers\\shop\\tpl\\cat.tpl',
      1 => 1639396009,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '76331099861af434b28c5d1-76086410',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_61af434b363382_85334395',
  'variables' => 
  array (
    'new' => 0,
    'category_id' => 0,
...
<?php if ($_valid && !is_callable('content_61af434b363382_85334395')) {function content_61af434b363382_85334395($_smarty_tpl) {?><form id="cat-form" action="" method="post" enctype="multipart/form-data">
            ...
            <h3 class="panel-title text-uppercase">
                ...
                <?php if (!$_smarty_tpl->tpl_vars['new']->value) {?>
                    <span class="pull-right text-lowercase">
                        ...
                        <a href="?c=shop&act=del&cid=<?php echo $_smarty_tpl->tpl_vars['category_id']->value;?>
        ...
        <div class="panel-body">
            ...
            <div class="form-horizontal" role="form">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input required value="<?php echo $_smarty_tpl->tpl_vars['item']->value['TITLE'];?>
" name="title" id="title" type="text" class="form-control" placeholder="Введите название категории">
                    </div>
                </div>
                <div class="form-group">
                    <label for="c_title" class="col-sm-3 control-label">Заголовок:</label>
                    <div class="col-sm-9">
                        <input value="<?php echo $_smarty_tpl->tpl_vars['item']->value['TITLE2'];?>
" name="title2" id="title2" type="text" class="form-control" placeholder="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="c_desc" class="col-sm-12 control-label">Описание:</label>
                    <div class="col-sm-12">
                        <textarea name="desc" id="desc" cols="30" rows="5" class="form-control textarea-edit"><?php echo $_smarty_tpl->tpl_vars['item']->value['DESC'];?>
</textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <textarea name="desc2" id="desc2" cols="30" rows="15" class="form-control textarea-edit"><?php echo $_smarty_tpl->tpl_vars['item']->value['DESC2'];?>
</textarea>
                    </div>
                </div>
                <div class="form-group">
...
?>
                                <?php if ($_smarty_tpl->tpl_vars['categories']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['ID']!==$_smarty_tpl->tpl_vars['category_id']->value) {?>
                                    <option <?php if ($_smarty_tpl->tpl_vars['categories']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['ID']==$_smarty_tpl->tpl_vars['item']->value['PARENT']) {?>selected="selected"<?php }?> value="<?php echo $_smarty_tpl->tpl_vars['categories']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['ID'];?>
...
" alt=""/>
            ...
            <div class="form-horizontal" role="form">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input value="<?php echo $_smarty_tpl->tpl_vars['item']->value['META_DESC'];?>
" name="meta_description" type="text" class="form-control" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input value="<?php echo $_smarty_tpl->tpl_vars['item']->value['META_KEYWORDS'];?>
