            ...
            <div class="comment-body">
                <div class="comment-meta">
                    <span class="comment-user">
                        ...
                        <?php echo $_smarty_tpl->tpl_vars['comments']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['USER_NAME'];?>
</span>
                    <span class="comment-date">
                        <i class="fa fa-clock-o"></i>
                        <?php echo $_smarty_tpl->tpl_vars['comments']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['DATE_PUBL'];?>
