...
?>
                        <option <?php if ($_smarty_tpl->tpl_vars['videos']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['ID']==$_smarty_tpl->tpl_vars['item']->value['VIDEO']) {?>selected<?php }?> value="<?php echo $_smarty_tpl->tpl_vars['videos']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['ID'];?>
