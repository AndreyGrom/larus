...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1539998241618e4f088d6120-26750155',
  'function' => 
  array (
  ),
  'variables' => 
...
&sn=comment" alt=""/></div>
        ...
        <?php }?>
        <div class="form-group">
            <button type="submit" class="btn btn-primary" style="width:100%;display:block"><i class="fa fa-comment"></i> Комментировать</button>
